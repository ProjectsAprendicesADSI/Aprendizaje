                ...
                <div class="user-nav">
                    <ul>
                        ...
                        <li class="profile-photo">
                            <img src="<?php echo $Foto ?>" style="max-height: 50px ; max-width: 50px" alt=""
                                 class="img-circle">
                        </li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="home1">
                                            <form class="form-horizontal" role="form" method="post"
                                                  action='../../controladores/controlleraula.php?action=crear'
                                                  novalidate>
                                                    ...
                                                    <?php if (!empty($_GET['respuesta'])) { ?>
                                                        <?php if ($_GET['respuesta'] == "correcto") { ?>
                                                            <div class="alert alert-success alert-dismissable">
                                                                ...
                                                                <strong>EL curso </strong> se registro con exito.
                                                            </div>
                                                        <?php } else { ?>
                                                            <div class="alert alert-danger alert-dismissable">
                                                                ...
                                                                <strong>El curso </strong> no se pudo registrar por
