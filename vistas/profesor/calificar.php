    ...
    <section id="container">
        ...
        <section class="main-content-wrapper">
            <section id="main-content">
                ...
                <div>
                    <?php $arrprofesor = classtrabajocrear::getAll2($idprofesor);
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"> <?php echo $profesor->getNombre(); ?></h3>

                            </div>
                            <div class="panel-body">
                                <?php echo $profesor->getdescripcion(); ?>
                                <br>
                                <br>
                                <h3><a HREF="verdatos.php?id=<?php echo base64_encode($profesor->getidtrabajo()); ?>" title="Ver archivos subidos"><i class="fa fa-eye"></i></a></h3>
                            </div>
                        </div>
                    </div>
                </div>
