    ...
    <section id="container">
        ...
        <section class="main-content-wrapper">
            <section id="main-content">
                ...
                <div>
                    <?php $arrprofesor = classtrabajocrear::getAll();
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <br>
                                <br>
                               <h3><a HREF="vamos.php?id=<?php echo base64_encode($profesor->getidtrabajo()); ?>" title="Subir archivos"><i class="fa fa-upload"></i></a></h3>
                            </div>
                        </div>
                    </div>
                </div>
